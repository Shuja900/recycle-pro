...
<body>
    ...
    <div id="wrapper" class="wrapper">
        ...
        <div class="row">
         ...
         <div class="row">
            <div class="col-md-2">
                <a href="iphone.php"><img style="border: 2px solid #41acff;"  src="images/iphone-button.jpg" >
                </div></a>
                <div class="col-md-2">
    ...
    <div style="background-color:#f4f4f4;">
     <div class="container">
      ...
      Removing your iCloud account using your device</h3>
...
6. Select ‘Sign Out’ and Enter your Apple ID password.</p>
<img src="images/iphoneaccount.jpg">
</div>
<div class="col-md-1">
    </div>
<div style="background-color:white;margin-top:5%;margin-bottom:5%;" class="col-md-5">
