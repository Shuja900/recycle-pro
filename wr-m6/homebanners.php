...
require_once('apps/wrback/homebanners/homebanners.class.php');
$layout_obj = new LayoutClass();
$frntbs_obj = new FrontBase();
$homeBann_obj = new HomeBannersClass();
...
<html lang="en">
<head>
      <?php $layout_obj->pageTitle('Manage Home Banners | Wr-Admin'); ?>
      <!-- Bootstrap -->
      ...
      <div class="container body">
         <div class="main_container">
            ...
            <div class="right_col" role="main">
               <div class="">
                  <?php $layout_obj->PageHeadings('Manage Home Banners'); ?>
                  <div class="clearfix"></div>
                  <?php 
						switch($index){
							case 'add': 
								if($sbtfrm=='sbtval')
									$homeBann_obj->AddFromToDb();
								else 
									$homeBann_obj->AddEditData('Add');
								break; 
							case 'edit':
								if($sbtfrm=='sbtval')
									$homeBann_obj->UpdateFormDb($id);
								else 
									$homeBann_obj->AddEditData('Edit',$id);
								break;
							case 'Delete':
									$homeBann_obj->DeleteData($id);
								break;
							default:
									$homeBann_obj->ShowAll();
								break;
						} 
				  ?>
               </div>
