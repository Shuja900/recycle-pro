...
require_once('apps/wrback/wr_basic/wr_basic.class.php');
$layout_obj = new LayoutClass();
$frntbs_obj = new FrontBase();
$wrbasic_obj = new WRBasic();
...
<html lang="en">
<head>
      <?php $layout_obj->pageTitle('Manage Website Basic Details | Wr-Admin'); ?>
      <!-- Bootstrap -->
      ...
      <div class="container body">
         <div class="main_container">
            ...
            <div class="right_col" role="main">
               <div class="">
                  <?php $layout_obj->PageHeadings('Manage Website Basic Details'); ?>
                  <div class="clearfix"></div>
                  <?php 
						switch($index){
							case 'add': 
								if($sbtfrm=='sbtval')
									$wrbasic_obj->AddFromToDb();
								else 
									$wrbasic_obj->AddEditData('Add');
								break; 
							case 'edit':
								if($sbtfrm=='sbtval')
									$wrbasic_obj->UpdateFormDb($id);
								else 
									$wrbasic_obj->AddEditData('Edit',$id);
								break;
							default:
									$wrbasic_obj->ShowAll();
								break;
