...
<head>
   ...
   <body class="nav-md dark-left-side">
               ...
               <div class="">
                  ...
                  <?php 
						switch($index){
							case 'add': 
								if($adduser=='sbtuser')
									$adminuser_obj->AddUserToDb();
								else 
									$adminuser_obj->AddEditUser('add');
								break; 
							case 'edit':
								if($adduser=='sbtuser')
									$adminuser_obj->UpdateUserDb($uid);
								else 
									$adminuser_obj->AddEditUser('Edit',$uid);
								break; 
								break;
							default:
								$adminuser_obj->ShowUsers();
								break;
						} 
				  ?>
               </div>
      ...
      <?php $adminuser_obj->DeleteJSCall(); ?>
