...
<div id="header">
   <?php /*?> <a class="" href="http://imageuploaderforckeditor.altervista.org/" target="_blank"><img src="img/cd-icon-image.png" class="headerIconLogo"></a><?php */?>
...
<?php if($file_style == "block") { ?>
    <?php /*?><div class="fileDiv" onClick="window.location.href = 'http://imageuploaderforckeditor.altervista.org';">
...
<?php } elseif($file_style == "list") { ?>
    <?php /*?><div class="fullWidthFileDiv" onClick="window.location.href = 'http://imageuploaderforckeditor.altervista.org';">
