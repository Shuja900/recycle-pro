...
$foldershistory[] = $useruploadfolder;
    ...
    $useruploadfolder = "demo/DZSecurity/dzpanel/ckeditor/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "demo/DZSecurity/dzpanel/ckeditor/plugins/imageuploader/uploads";
        

    $useruploadfolder = "demo/DZSecurity/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "demo/DZSecurity/uploads";
        

    $useruploadfolder = "demo/healthintegrative/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "demo/healthintegrative/uploads";
        

    $useruploadfolder = "healthintegrative/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "healthintegrative/uploads";
    ...
    $useruploadfolder = "live/fitlife3/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "live/fitlife3/uploads";
    ...
    $useruploadfolder = "/sarthak/uploads/";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "/sarthak/uploads/";
