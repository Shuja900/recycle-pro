...
require_once('apps/wrback/pages/categories.class.php');
      ...
      <div class="container body">
         <div class="main_container">
            ...
            <div class="right_col" role="main">
               <div class="">
                  <?php $layout_obj->PageHeadings('Manage Categories'); ?>
						...
						switch($index){
							case 'add': 
								if($sbtfrm=='sbtval')
									...
									$cat_obj->AddEditData('Add');
								break; 
							case 'edit':
								if($sbtfrm=='sbtval')
									$cat_obj->UpdateFormDb($id);
								else 
									$cat_obj->AddEditData('Edit',$id);
								break; 
							default:
								$cat_obj->ShowAll();
								break;
