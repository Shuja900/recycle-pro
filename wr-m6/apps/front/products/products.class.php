...
$uki="product-view.php?name=".$names."&pid=".$_GET['pid']."&vid=".$_GET['vid']."";
            ...
            <div class="row">
                <div class="col-md-12">
                    <div style="padding: 25px;  margin-top: 40px; ">
                        <h1 class="white centerTextAlign roboto mobih"
                            style="font-size: 2.750em; margin-bottom:5px;color:white;text-align:center;">Sell your
                            <?php echo $_REQUEST['b']; ?> - with Recyclepro</h1>
                        <p style="font-size: 15px; margin-bottom:5px;color:white;text-align:center;">Find out your
                            <?php echo $_REQUEST['b']; ?> by entering your Laptop Name. </p>
                            ...
                            <div class="col-md-6">
                                <div class="pdetails-allinfo">
                                    ...
                                    <div class="pdetails-description">
                                        ...
                                        <input
                                            style="width:80%!important;background:white!important;line-height:0px!important;"
                                            type="text" name="mob-search-field" id="mob-search-field"
                                            class="wr-search-field typeahead" placeholder="Enter Your Laptop Name" />
                                        <button
                                            style="width:20%!important;background:#7bcb58!important;color:white!important;line-height:0px!important;"
                                            name="mob-search-btn" class="wr-search-btn" type="button">FIND</button>
...
<div class="container">
    <div id="myDIV" class="shop-page-products mt-30">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12"
            onclick="document.location='sell_laptop.php?id=<?php echo $arr['id']; ?>&pc=<?php echo $_REQUEST['pc']; ?>&b=<?php echo $_REQUEST['b']; ?>'">
            <article class="hoproduct">
                <div class="hoproduct-image text-center">
                    <a
                        href="sell_laptop.php?id=<?php echo $arr['id']; ?>&pc=<?php echo $_REQUEST['pc']; ?>&b=<?php echo $_REQUEST['b']; ?>">
                        <a class="hoproduct-thumb text-center"
                            href="sell_laptop.php?id=<?php echo $arr['id']; ?>&pc=<?php echo $_REQUEST['pc']; ?>&b=<?php echo $_REQUEST['b']; ?>">
                            <?php
										if (file_exists('wr-m6/updated/' . str_replace(' ', '-', $arr['productname']) . '.webp')) {
											?>
                            <img class="hoproduct-frontimage text-center"
                                src="wr-m6/updated/<?php echo str_replace(' ', '-', $arr['productname']); ?>.webp"
                                alt=" Sell <?php echo $arr['productname']; ?>">
                            <?php
										} else {
											?>
                            <img class="hoproduct-frontimage text-center" src="wr-m6/updated/notavailable.webp"
                                alt=" Sell <?php echo $arr['productname']; ?>">
                            <?php
										}
										?></a>
                        <a style="background-color:#13564f;"
                            href="sell_laptop.php?id=<?php echo $arr['id']; ?>&pc=<?php echo $_REQUEST['pc']; ?>&b=<?php echo $_REQUEST['b']; ?>">
                            <h2 style="color:#333333; font-size:12px; margin-top:20px;">
                                <?php echo $arr['productname']; ?></h2>
                        </a>
                        <a style="background-color:#13564f;"
                            href="sell_laptop.php?id=<?php echo $arr['id']; ?>&pc=<?php echo $_REQUEST['pc']; ?>&b=<?php echo $_REQUEST['b']; ?>"
                            class="btn btn-success btn-sm text-white" style="margin-bottom:5px;">Sell Now</a>
                    </a>
                </div>
            </article>
        </div></a>
        ...
        <div class="no-product-found text-center">
            <div class="no-product-img" style="margin-bottom: 16px;">
                <img src="images/empty-cart.png" alt="NoProductFound" height="100px" width="100px" />
            </div>
            <span style="color: #13564f!important;font-size: 18px;">No Products Found! :(</span>
            <p style="color: #13564f!important;">This means we are buying anything in this category </p>
        </div>
        <?php
			}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div style="padding: 25px;  margin-top: 40px; ">
                        <h1 class="white centerTextAlign roboto mobih"
                            style="font-size: 2.750em; margin-bottom:5px;color:white;text-align:center;">Sell your
                            <?php echo $_REQUEST['b']; ?> - <?php echo $ProCatName; ?>'s with Recyclepro</h1>
                        <p style="font-size: 13px; margin-bottom:5px;color:white;text-align:center;">Find out your
                            <?php echo $_REQUEST['b']; ?> - <?php echo $ProCatName; ?>'s by entering your
                            <?php echo $ProCatName; ?> Name. </p>
                            ...
                            <div class="col-md-4">
                                <div class="pdetails-allinfo">
                                    ...
                                    <div class="pdetails-description">
                                        ...
                                        <input style="background-color:white" type="text" name="mob-search-fields"
                                            id="mob-search-fields" class="wr-search-field typeahead"
                                            placeholder="Enter your item (Eg: Iphone 7)..." />
                                        <ul class="divcontact dropdown-menu src" role="listbox"
                                            style="top: 98px; left: 15px;">

                                        </ul>
                                        <button
                                            style="width:20%!important;background:#7bcb58!important;color:white!important;line-height:0px!important;"
                                            name="mob-search-btn" class="wr-search-btn" type="button"
...
<div class="container">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                <article class="hoproduct ">
                    <div class="hoproduct-image text-center">
                        ...
                        <a class="hoproduct-thumb text-center" style="cursor: pointer;" data-toggle="modal"
                            data-target="#exampleModalCenter" data-product-name="<?php echo $arr['productname']; ?>"
                            data-product-img="<?php echo 'wr-m6/updated/'.str_replace(' ','-',$arr['productname']).'.webp'; ?>">
                            <?php if(file_exists('wr-m6/updated/'.str_replace(' ','-',$arr['productname']).'.webp')) { ?>
                            <img class="hoproduct-frontimage text-center btn-opn"
                                src="wr-m6/updated/<?php echo str_replace(' ','-',$arr['productname']); ?>.webp"
                                alt="Sell <?php echo $arr['productname']; ?>">
                            <?php } else { ?>
                            <img class="btn-opn hoproduct-frontimage text-center" src="wr-m6/updated/notavailable.webp"
                                alt="Sell <?php echo $arr['productname']; ?>">
                            <?php } ?>
                        </a>

                        <h2 class="qv-name" style="color:#333333; font-size:12px; margin-top:20px;">
                            <?php echo $arr['productname']; ?></h2>
                ...
                foreach ($record2 as $arr2) { ?>
                            <a style="background-color:#13564f;"
                                href="product-view.php?name=<?php echo str_replace(' ','-',$arr['productname']);?>&pid=<?php echo $arr['id']; ?>&vid=<?php echo $arr2['variant']; ?>"
                                class="btn btn-success btn-sm text-white"
                                style="margin-bottom:5px;"><?php echo $this->getProductVariant($arr2['variant']); ?></a>
                            <?php } ?>
                        </div>
                        ...
                        <div class="container-fluid">
                            <div class="quick-view-pro">
                                <div class="row align-items-center">
                                    <div class="col-md-6">
                                        <div class="qv-img">
                                            <img class="modal__product-img" src="" alt="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="qv-details">
                                            <h5 class="modal__product-title"></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div id="msg" style="display:none;" class="alert alert-warning">
        if you unable to find your product then please<strong><a style="color:blue;"
                href="javascript:void(Tawk_API.toggle())">click here</a></strong>to start live chat
    </div>
    ...
    <div class="container">
        <div class="ho-breadcrumb">
            <ul>
                ...
                <li><a
                        href="products.php?b=<?php echo $brandURL; ?>&bid=<?php echo $row['brand']; ?>&pc=<?php echo $row['category']; ?>"><?php echo $brandname; ?></a>
                </li>
...
<script type="application/ld+json">
{
    ...
    "offers": {
        "@type": "AggregateOffer",
        "url": "http://www.recyclepro.co.uk/product-view.php?name=<?php echo str_replace(' ','-',$product); ?>&pid=<?php echo $pid; ?>&vid=<?php echo $vid; ?>",
...
<div class="container">
    ...
    <form name="prosell" id="procell" action="" method="post">
        <div class="pdetails">
            <div class="row">
                <div class="col-lg-12">
                    <h1><span class="text-primary-wr text-uppercase"><?php  echo $brandname; ?></span> :
                        <?php echo $product; ?> - <?php echo $varient; ?></h1>
                </div>
                <!--<div class="col-lg-3">
			</div>-->
                <div class="col-lg-7">
                            ...
                            <div class="pdetails-images">
                                <div class="">
                                    <div class="pdetails-singleimage border-blue-wr">
                                        <?php
                                          if(file_exists('wr-m6/updated/'.str_replace(' ','-',$product).'.webp'))
                                          {
                                          ?>
                                        <img src="wr-m6/updated/<?php echo str_replace(' ','-',$product); ?>.webp"
                                            alt="Sell <?php echo $product.' '.$varient; ?>">
                                        <?php
                                          }
                                          else
                                          {
                                          ?>
                                        <img class="hoproduct-frontimage text-center"
                                            src="wr-m6/updated/notavailable.webp" alt=" Sell <?php echo $product; ?>">
                        ...
                        <div class="col-lg-8">
                            <div class="pdetails-content">
                                <div class="pdetails-pricebox">
                                    ...
                                    <span class="price">Offer Price: &pound;<span
                                            class="propricediv"><?php echo $price; ?></span></span>
					...
					$x=1;
						if($row_procat['category']=='Phones' || $row_procat['category']=='Tablets' || $row_procat['category']=='Smart Watch' || $row_procat['Macbook']=='Ipad'){
							?>
								...
								?>
                                        <a href="javascript:void;" class="netwrkval networkimg"
                                            data-id="<?php echo $row2['id']; ?>"
                                            data-pr="<?php echo $productAgeCost; ?>"
                                            data-net-name="<?php echo $row2['network_name']; ?>">
                                            <img src="<?php echo 'uploads/'.$row2['network_img']; ?>"
                                                title="<?php echo $row2['network_name']; ?>"
                                                alt="<?php echo $row2['network_name']; ?>" class="">
                                        </a>
                                        <?php
									}
								?>
                                            ...
                                            <tr>
                                                <td class="product-quantity">
                                                    ...
                                                    <div class="quantity-select">
                                                        <input type="text" value="1" name="proqty" id="proqty"
                                                            class="proqtycall">
                                                        <div class="inc qtybutton" onclick="coset()">+<i
                                                                class="ion ion-ios-arrow-up"></i></div>
                                                        <div class="dec qtybutton">-<i
                                                                class="ion ion-ios-arrow-down"></i></div>
                                                    </div>
                                                </td>
                                                <td class="pro-title">
                                                    <?php echo $product; ?> <?php echo $varient; ?>
                                                </td>
                                                <td class="pro-price"><span>&pound;<span
                                                            class="propricediv"><?php echo $price;  ?></span></span>
                                                </td>
                                            </tr>
                                        </tbody>
                            ...
                            <div id="conditionWrapper">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <a href="javascript:void;" class="ho-button mobcondi" data-id="Good"
                                            data-val="<?php echo $price; ?>" id="goodprz">
                                            <span>Good</span>
                                        </a>
                                        <a href="javascript:void;" class="ho-button mobcondi" data-id="worn"
                                            data-val="<?php echo $FLprice; ?>" id="faultyprz">
                                            <span>Worn</span>
                                            <!-- <span>Faulty</span> -->
                                        </a>
                                        <a href="javascript:void;" class="ho-button mobcondi" data-id="faulty"
                                            data-val="<?php echo $SCprice; ?>" id="scrapprz">
                                            <!-- <span>Scrap</span> -->
                                            <span>Faulty</span>
                                        </a>
                                        <?php
							    ...
							    if($price=='0')
							    {
							        ?>
                                        ...
                                        <div style="margin-top:3%;background-color:#eeeeee;" class="alert alert-danger">
                                            <strong>Alert!</strong> *Unfortunately we will not be able to make an offer
                                            on this item any longer due to its age. However we can send you a free
                                            shipping label or even get it collected and recycle it responsibly. (for
                                            collections you will have to place an order 1st and follow the
                                            instructions).
                                        </div>
                                        <?php
			}
			?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/REC-MOB-GOOD-CON.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
                                        <?php
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/Tablet-Good-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/Laptop-Good-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/Smart-Watch-Good-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/Airpods-Good-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/iPod-Good-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/Speaker-Good-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/Gaming-Console-Good-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/REC-MOB-WORN-CON.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/Tablet-Worn-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/Laptop-Worn-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/Smart-Watch-Worn-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/Airpods-Worn-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/iPods-Worn-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/Speaker-Worn-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/Gaming-Console-Worn-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/REC-MOB-FAULTY-CON.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/Tablet-Faulty-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/Laptop-Faulty-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/Smart-Watch-Faulty-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/Airpods-Faulty-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/iPods-Faulty-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/Speaker-Faulty-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
							    ...
							    ?>
                                        <img style="margin-top:3%;"
                                            src="https://recyclepro.co.uk/images/Gaming-Console-Faulty-Condition.webp"
                                            alt="<?php echo $row_procat['category']; ?>" />
                                        <?php
							    }
							    ?>
                            ...
                            <table class="table">
                                ...
                                <tfoot>
                                    ...
                                    <tr class="total-price">
                                        ...
                                        <td class="text-right">&pound;<span id="totalrez"><?php echo $price; ?></span>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
				...
				{
					?>
                        <div style="display:flex;cursor:pointer;" class="mt-30"
                            onclick="document.location='iphone.php'">
                            <div style="margin-right:2%!important;">
                                <img src="wr-m6/uploads/brand1546772237.webp" width="100px" height="60px"
                                    alt="<?php echo "Sell ".$brandname; ?>">
                            </div>
                            <div>
                                <h3 style="font-size:15px;font-weight:600;color:#13564f;margin-bottom:2px;">Selling an
                                    Apple Device?</h3>
                                <p style="line-height:initial;margin-top:0px">Please REMOVE your iCloud account before
                                    sending your device to us.</p>
                            </div>
                        </div>
                        <?php
			}
				 ...
				 if($brandname=="Sony" && $c=="Phones")
				{
					?>
                        <div style="display:flex;cursor:pointer;" class="mt-30" onclick="document.location='sony.php'">
                            <div style="margin-right:2%!important;">
                                <img src="wr-m6/uploads/brand1546772246.webp" width="100px" height="60px"
                                    alt="<?php echo "Sell ".$brandname; ?>">
                            </div>
                            <div>
                                <h3 style="font-size:15px;font-weight:600;color:#13564f;margin-bottom:2px;">Selling a
                                    Sony Device?</h3>
                                <p style="line-height:initial;margin-top:0px">Please REMOVE your Google account before
                                    sending your device to us.</p>
                            </div>
                        </div>
                        <?php
				 ...
				 if($brandname=="SONY" && $c=="Tablets")
				{
					?>
                        <div style="display:flex;cursor:pointer;" class="mt-30"
                            onclick="document.location='sonytablet.php'">
                            <div style="margin-right:2%!important;">
                                <img src="wr-m6/uploads/brand1546772246.webp" width="100px" height="60px"
                                    alt="<?php echo "Sell ".$brandname; ?>">
                            </div>
			...
			?>
				 ...
				 if($brandname=="One Plus")
				{
					?>
                        <div style="display:flex;cursor:pointer;" class="mt-30"
                            onclick="document.location='oneplus.php'">
                            <div style="margin-right:2%!important;">
                                <img src="wr-m6/uploads/brand1546772276.webp" width="100px" height="60px"
                                    alt="<?php echo "Sell ".$brandname; ?>">
                            </div>
                            <div>
                                <h3 style="font-size:15px;font-weight:600;color:#13564f;margin-bottom:2px;">Selling a
				 ...
				 if($brandname=="Huawei" && $c=="Phones")
				{
					?>
                        <div style="display:flex;cursor:pointer;" class="mt-30"
                            onclick="document.location='huawei.php'">
                            <div style="margin-right:2%!important;">
                                <img src="wr-m6/uploads/brand1546772276.webp" width="100px" height="60px"
                                    alt="<?php echo "Sell ".$brandname; ?>">
                            </div>
				 ...
				 if($brandname=="HUAWEI" && $c=="Tablets")
				{
					?>
                        <div style="display:flex;cursor:pointer;" class="mt-30"
                            onclick="document.location='huaweitablet.php'">
                            <div style="margin-right:2%!important;">
                                <img src="wr-m6/uploads/brand1568875281.webp" width="100px" height="60px"
                                    alt="<?php echo "Sell ".$brandname; ?>">
                            </div>
                            <div>
                                <h3 style="font-size:15px;font-weight:600;color:#13564f;margin-bottom:2px;">Selling a
				 ...
				 if($brandname=="Huawei" && $c=="Smart Watch")
				{
					?>
                        <div style="display:flex;cursor:pointer;" class="mt-30"
                            onclick="document.location='huaweiwatch.php'">
                            <div style="margin-right:2%!important;">
                                <img src="wr-m6/uploads/brand1568875281.webp" width="100px" height="60px"
                                    alt="<?php echo "Sell ".$brandname; ?>">
                            </div>
				 ...
				 if($brandname=="Samsung" && $c=="Phones")
				{
					?>
                        <div style="display:flex;cursor:pointer;" class="mt-30"
                            onclick="document.location='samsung.php'">
                            <div style="margin-right:2%!important;">
                                <img src="wr-m6/uploads/brand1546772254.webp" width="90px" height="60px"
                                    alt="<?php echo "Sell ".$brandname; ?>">
                            </div>
                            <div>
                                <h3 style="font-size:15px;font-weight:600;color:#13564f;margin-bottom:2px;">Selling a
				 ...
				 if($brandname=="SAMSUNG" && $c=="Tablets")
				{
					?>
                        <div style="display:flex;cursor:pointer;" class="mt-30"
                            onclick="document.location='samsungtablet.php'">
                            <div style="margin-right:2%!important;">
                                <img src="wr-m6/uploads/brand1546772254.webp" width="90px" height="60px"
                                    alt="<?php echo "Sell ".$brandname; ?>">
                            </div>
				 ...
				 if($brandname=="SAMSUNG" && $c=="Smart Watch")
				{
					?>
                        <div style="display:flex;cursor:pointer;" class="mt-30"
                            onclick="document.location='samsungwatch.php'">
                            <div style="margin-right:2%!important;">
                                <img src="wr-m6/uploads/brand1546772254.webp" width="90px" height="60px"
                                    alt="<?php echo "Sell ".$brandname; ?>">
                            </div>
				 ...
				 if($brandname=="Google Pixel")
				{
					?>
                        <div style="display:flex;cursor:pointer;" class="mt-30"
                            onclick="document.location='googlepixel.php'">
                            <div style="margin-right:2%!important;">
                                <img src="wr-m6/uploads/brand1569411509.webp" width="100px" height="60px"
                                    alt="<?php echo "Sell ".$brandname; ?>">
                            </div>
                            <div>
                                <h3 style="font-size:15px;font-weight:600;color:#13564f;margin-bottom:2px;">Selling a
                                    Google Pixel Device?</h3>
                                <p style="line-height:initial;margin-top:0px">Please REMOVE your Google account before
                                    sending your device to us.</p>
                            </div>
                        </div>
				 ...
				 if($brandname=="Motorola" && $c=="Smart Watch")
				{
					?>
                        <div style="display:flex;cursor:pointer;" class="mt-30"
                            onclick="document.location='motorolawatch.php'">
                            <div style="margin-right:2%!important;">
                                <img src="wr-m6/uploads/brand1570099624.webp" width="100px" height="60px"
                                    alt="<?php echo "Sell ".$brandname; ?>">
                            </div>
                            <div>
                                <h3 style="font-size:15px;font-weight:600;color:#13564f;margin-bottom:2px;">Selling an
                                    Motorola Device?</h3>
                                <p style="line-height:initial;margin-top:0px">Please Reset your Watch before sending
                                    your device to us.</p>
                            </div>
                        </div>
                        <?php
				 ...
				 if($brandname=="ALCATEL" && $c=="Smart Watch")
				{
					?>
                        <div style="display:flex;cursor:pointer;" class="mt-30"
                            onclick="document.location='alcatel.php'">
                            <div style="margin-right:2%!important;">
                                <img src="wr-m6/uploads/brand1570100535.webp" width="100px" height="60px"
                                    alt="<?php echo "Sell ".$brandname; ?>">
                            </div>
                            <div>
                                <h3 style="font-size:15px;font-weight:600;color:#13564f;margin-bottom:2px;">Selling an
				 ...
				 if($brandname=="Garmin" && $c=="Smart Watch")
				{
					?>
                        <div style="display:flex;cursor:pointer;" class="mt-30"
                            onclick="document.location='garmin.php'">
                            <div style="margin-right:2%!important;">
                                <img src="wr-m6/uploads/brand1570101901.webp" width="100px" height="60px"
                                    alt="<?php echo "Sell ".$brandname; ?>">
                            </div>
                            <div>
                                <h3 style="font-size:15px;font-weight:600;color:#13564f;margin-bottom:2px;">Selling an
				 ...
				 if($brandname=="Fitbit" && $c=="Smart Watch")
				{
					?>
                        <div style="display:flex;cursor:pointer;" class="mt-30"
                            onclick="document.location='fitbit.php'">
                            <div style="margin-right:2%!important;">
                                <img src="wr-m6/uploads/brand1570181611.webp" width="100px" height="60px"
                                    alt="<?php echo "Sell ".$brandname; ?>">
                            </div>
                            <div>
                                <h3 style="font-size:15px;font-weight:600;color:#13564f;margin-bottom:2px;">Selling an
				 ...
				 if($brandname=="LG" && $c=="Smart Watch")
				{
					?>
                        <div style="display:flex;cursor:pointer;" class="mt-30"
                            onclick="document.location='lgwatch.php'">
                            <div style="margin-right:2%!important;">
                                <img src="wr-m6/uploads/brand1570098718.webp" width="100px" height="60px"
                                    alt="<?php echo "Sell ".$brandname; ?>">
                            </div>
                            <div>
                                <h3 style="font-size:15px;font-weight:600;color:#13564f;margin-bottom:2px;">Selling an
				...
				?>
                        ...
                        <?php
									if(($_SESSION['products'])==2 OR ($_SESSION['products'])>2 )
									{
									    ?>

                        <div style="padding:0%;margin-top:4%;font-size:19px;" class="alert alert-danger">
                            <p style="padding-left:2%;"><strong>Alert</strong> * You can only cart 2 items at a time !
                            </p>
                        </div>
                        <?php
									}
                        ...
                        <button class="ho-button ho-button-fullwidth mt-30 " type="submit" name="submit"
                            value="prosubmit">
            ...
            <div class="cart-table table-responsive">
                <table class="table table-bordered table-hover mb-0 dks">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <a href="product-view.php?pid=<?php echo $product['pid']; ?>&vid=<?php echo $product['vid']; ?>"
                                    class="product-image">
                                    <img src="wr-m6/uploads/<?php echo $row['pro_img']; ?>"
                                        alt="Sell <?php echo $row['productname'].' '.$varient; ?>">
                                </a>
                                <p><a href="product-view.php?pid=<?php echo $product['pid']; ?>&vid=<?php echo $product['vid']; ?>"
                                        class="product-title">
                            ...
                            <td>
                                <button type="button" class="remove-product delcart" data-id="<?php echo $x-1; ?>"><i
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
												if($product['product_condition']!='Scrap'){
													if($row['category']=='1' || $row['category']=='2' || $row['category']=='7' || $row['category']=='8' || $row['category']=='9' ) {?>
                            Network Fee: <?php echo 'Unlocked' ?> -
                            &pound;<?php echo $product['network_price']; ?><br />
                            <?php
													}
												} ?>
                            Product Condition: <?php echo $product['product_condition']; ?>
                    ...
                    <div class="col-lg-8 col-md-6 col-12">
                        <div class="cart-content-left">
                            <div class="ho-buttongroup">
                                <a href="cart.php?index=clearcart" class="ho-button ho-button-sm"
                                    style="margin-bottom:5px;"><span>Clear Cart</span></a>
                            ...
                            <div style="display:flex;border:4px solid #41acff; padding:4%; margin-top:3%;">
                                ...
                                <div style="margin-left:3%;">
                                    <h4 style="color: #41acff;font-size: 23px;font-weight:800;margin-left:2%;">Get £5
                                        extra!</h4>
                                    <p style="font-size:19px!important;color:black;font-weight:500;">Add another device
                                        over £50 and we'll give you £5 extra!</p>
                                    <a href="" class="ho-button ho-button-sm" style="margin-bottom:5px;"><span>Add
                                            Device</span></a>
                                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal"
                                        data-target="#myModals">Term & Conditions</button>
                                </div>
                            </div>
                            <?php
									}
                            ...
                            <div class="modal fade" id="myModals" role="dialog">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <h4>£5 extra voucher is applicable on an additional phone added to your
                                                basket with a value of greater than £50 and subject to us satisfactorily
                                                testing your device and you accepting changes if needed.</h4>
                                        </div>
                                        <div class="modal-footer">
...
function coset() {
    ...
    if (proqtyxx > 2) {
        alert('* You can only cart 2 items at a time !');
        $("#proqty").val('2');
    } else {
        if (condixx == 'worn') {
...
$("form").submit(function() {
    if (validationIsTrue()) {
        ...
        document.getElementById('pgerr').innerHTML = 'Please complete all steps. <br> ';
        var val1 = $("#network").val();
        if (val1 == "") {
            document.getElementById('pgerr').innerHTML += 'Please select Network. <br>';
            var networkWrapper = document.getElementById("networkWrapper");
            networkWrapper.style.border = "2px solid red";
            networkWrapper.style.padding = "10px";
        } else {
            var networkWrapper = document.getElementById("networkWrapper");
            networkWrapper.style.border = "0px";
            networkWrapper.style.padding = "0px";
        }
        var val3 = $("#product_condition").val();
        if (val3 == "") {
            document.getElementById('pgerr').innerHTML += 'Please select Condition.';
            var conditionWrapper = document.getElementById("conditionWrapper");
            conditionWrapper.style.border = "2px solid red";
            conditionWrapper.style.padding = "10px";
        } else {
            var conditionWrapper = document.getElementById("conditionWrapper");
            conditionWrapper.style.border = "0px";
            conditionWrapper.style.padding = "0px";
        }
        //   	document.getElementById('pgerr').innerHTML='Please complete all steps. <br> First, select the network.</li><li>Second, select the condition.</li></ol>';
        //     var networkWrapper = document.getElementById("conditionWrapper");
        //     conditionWrapper.style.border = "2px solid red";
        //     conditionWrapper.style.padding = "10px";
        return false;
    }
            ...
            <div id="b1" class="col-sm-4 mt-12">
                ...
                <a id="b1">
                    <div style="display:flex;border:2px solid #7bcb58; padding:10%;">
                        ...
                        <h4 style="color: #7bcb58;font-size: 15px;font-weight:600;margin-top:8%;margin-left:2%;">Bank
                            Transfer</h4>
                    </div>
                </a>
            ...
            <div id="b2" class="col-sm-4 mt-12">
                ...
                <a id="b2">
                    <div style="display:flex;border:2px solid #41acff; padding:10%;">
                        ...
                        <h4 style="color: #41acff;font-size: 15px;font-weight:600;margin-top:8%;margin-left:2%;">PayPal
                        </h4>
                    </div>
                </a>
            </div>
            ...
            <div id="b4" class="col-sm-4 mt-12">
                <a id="b4">
                    <div style="display:flex;border:2px solid #da7f8f; padding:10%;">
                        ...
                        <h4 style="color:#da7f8f;font-size: 15px;font-weight:600;margin-top:8%;margin-left:2%;">Donate
                            to Charity</h4>
                    </div>
                </a>
            </div>
...
?>
                    <div class="col-lg-6">
                        ...
                        <div class="ho-form">
                            <div class="ho-form-inner">
                                <h3 style="color: #41acff;font-size: 29px;font-weight:600;margin-top:4%;">Bank Transfer
                                </h3>

                                <img style="width:300px;height:200px;" src="charities/act.jpg">
                                <p style="color: #666;font-weight:400;font-size:13px;text-align:justify;">Choose our
                                    super easy Bank Transfer option to receive the money directly into your account.</p>
                                <p style="color: #666;font-weight:400;font-size:13px;text-align:justify;"><strong>we pay
                                        same day we receive item and your cash clears instantly</strong></p>
                                ...
                                <div class="single-input">
                                    ...
                                    <input type="text" name="full_name" id="full_name"
                                        value="<?php echo $detail['fname'].' '.$detail['lname']; ?>">
                                </div>

                                <div class="single-input">
                                    <label for="account_no">Account Number *</label>
                                    <input type="number" min="01111111" max="99999999" name="account_no" id="account_no"
                                        required>
                                </div>
                            </div>
                        </div>
                        <div id="country_GB">
                            <div class="row">
                                <div class="col-sm-12 mt-10">
                                    ...
                                    <input type="number" min="011111" max="999999" name="sort_code" id="sort_code">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="order-infobox">
                                ...
                                <table class="table">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr class="total-price">
                                            ...
                                            <td class="text-right">&pound;<?php echo $grandtotal+$_SESSION['bonus']; ?>
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
                            ...
                            <button class="ho-button ho-button-fullwidth mt-30" type="submit" name="proceed1"
                                value="proceedsbt1">
                                <span>Proceed</span>
                            </button>
                        </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="ho-form">
                            <div class="ho-form-inner">
                                ...
                                <p style="color: #666;font-weight:400;font-size:15px;text-align:justify;">Get paid
                                    quickly and securely via PayPal! Just enter your PayPal ID below and we'll deposit
                                    your cash directly to your PayPal account same day we receive your stuff.</p>
                                ...
                                <div class="single-input">
                                    ...
                                    <input type="text" name="paypal" id="paypal"
                                        value="<?php echo $dtl['paypal_email'];?>" required>
                                </div>
                                <p style="color: #666;font-weight:400;font-size:15px;text-align:justify;"><strong>Please
                                        check your PayPal email address is correct before proceeding.</strong></p>
                            </div>
                        </div>
                    </div>
...
?>
                    <div class="col-lg-6">
                        ...
                        <input type="hidden" name="addr" id="addr"
                            value="<?php echo $detail['address1'].','.$detail['address2'].','.$detail['postcode']; ?>">
                        <div class="ho-form">
                            <div>
                                <h3 style="color: #41acff;font-size: 29px;font-weight:600;">Cheque</h3>
                                <p style="color: #666;font-weight:400;font-size:15px;text-align:justify;">We'll send a
                                    cheque made payable to the name on your account on the day your items arrive.</p>
                                <p style="color: #666;font-weight:400;font-size:15px;text-align:justify;"><strong>Please
                                        note: if you want to get paid faster, we recommend Bank Transfer or
                                        PayPal!</strong></p>
                                <h3 style="color: #41acff;font-size: 19px;font-weight:600;">You Detail</h3>

                                <p style="color:black;font=size:15px;font-weight:600">NAME ON CHEQUE -
                                    <?php echo $detail['fname'].' '.$detail['lname']; ?> <button
                                        style="line-height:1px!important;height:23px!important;font-size:13px;"
                                        type="button" class="btn btn-info btn-md" data-toggle="modal"
                                        data-target="#myModal"> Edit</button></p>
                                <p style="color: #666;font-weight:400;font-size:15px;text-align:justify;">Your cheque
                                    will be made payable to this name.</p>

                                <p style="color:black;font=size:15px;font-weight:600">ADDRESS -
                                    <?php echo $detail['address1'].','.$detail['address2'].','.$detail['postcode']; ?>
                                    <button style="line-height:1px!important;height:23px!important;font-size:13px;"
                                        type="button" class="btn btn-info btn-md" data-toggle="modal"
                                        data-target="#myModal1">Edit</button>
                                </p>
                                <p style="color: #666;font-weight:400;font-size:15px;text-align:justify;">We'll post
                                    your cheque to the address above.</p>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="ho-form-inner">
                                            ...
                                            <div class="single-input ">
                                                ...
                                                <input type="text" id="fname" name="fname"
                                                    value="<?php echo $detail['fname']; ?>" required>
                                            </div>
                                            <div class="single-input ">
                                                <label for="account-details-lastname">Last Name*</label>
                                                <input type="text" id="lname" name="lname"
                                                    value="<?php echo $detail['lname']; ?>" required>
                                            </div>
                                            <div class="single-input">
                                                <a style="color:white!important;" href="" type="button"
                                                    class="btn btn-info btn-md" onclick="insert()">Update</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                        ...
                                        <div class="ho-form-inner">
                                            ...
                                            <div class="single-input ">
                                                ...
                                                <input type="text" id="addr1" name="addr1"
                                                    value="<?php echo $detail['address1']; ?>" required>
                                            </div>
                                            <div class="single-input ">
                                                <label for="account-details-lastname">Address 2*</label>
                                                <input type="text" id="addr2" name="addr2"
                                                    value="<?php echo $detail['address2']; ?>">
                                            </div>
                                            <div class="single-input ">
                                                <label for="account-details-lastname">Post Code*</label>
                                                <input type="text" id="pcode" name="pcode"
                                                    value="<?php echo $detail['postcode']; ?>" required>
                                            </div>
                                            <div class="single-input">
                                                <a style="color:white!important;" href="" type="button"
                                                    class="btn btn-info btn-md" onclick="insertaddresses()">Update</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
?>
		...
		$detail = $this->db->row($sql_usr,$this->db->pdo_open());
?>
                                <h3 style="color: #41acff;font-size: 29px;font-weight:600;margin-top:4%;">Donate to
                                    Charity</h3>
                                <p style="color: #666;font-weight:400;font-size:15px;text-align:justify;">If you’d like
                                    your payment in the form of a charitable donation then it’s really simple to do; we
                                    work with some great charities who do an amazing job for a diverse range of causes.
                                </p>
                                ...
                                <p style="color: #666;font-weight:400;font-size:13px;text-align:justify;margin-top:2%;">
                                    <strong>Once you’ve made your selection from the dropdown menu, simply click
                                        'Proceed'.</strong>
                                </p>
                                <input type="hidden" name="country" id="country" value="GB">
                                <input type="hidden" name="full_name" id="full_name"
...
if($charity)
	...
	?>
<script>
window.location = 'checkout.php?chk=1&oid=<?php echo $id; ?>';
</script>
<?php
}
function CheckOut(){
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                Product Condition: <?php echo $product['product_condition']; ?>
                                <?php if($product['product_condition']=='Good') echo '(No deduction in price)'; else { echo '50% deduction in product price.'; } ?>
                            </td>
                            <td>&pound;<?php echo $product['price']; ?></td>
                            <td>
                                <div class="quantity-select">
		   ...
		   $grandtotal=$grandtotal+$product['total'];
            ...
            <div class="row">
                <div style="margin-top:4%;" class="col-lg-12">
                    ...
                    <!--</div>-->
                    <div class="alert alert-danger">
                        <strong>Alert!</strong> *Please select the condition of your device carefully, if it does not
                        match while being checked by our technicians.
                    </div>
                </div>
            </div>
            <div class="cart-content">
                            ...
                            <div class="ho-buttongroup">
                                ...
                                <table class="table table-bordered table-hover mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="2"><strong>Account Number:</strong>
                                                <?php echo $record['account_no']; ?></td>
                                        </tr>
                                        <?php if($record['country']=="GB") {?>
                                        <tr>
                                            <td colspan="2"><strong>Sort Code:</strong>
                                                <?php echo $record['sort_code']; ?></td>
                                        </tr>
                                        <?php
											}
											else{
                                        ...
                                        <tr>
                                            ...
                                            <td><strong><?php echo $record['extra']; ?>:</strong>
                                                <?php echo $record['extra_val']; ?></td>
                                        </tr>
                                        <?php
											}
											?>
                                        <tr>
                                            <td colspan="2"><strong>Paypal_Email:</strong>
                                                <?php echo $record['paypal_email']; ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"><strong>Charity Name:</strong>
                                                <?php echo $record['charity_name']; ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"><strong>Cheque Address:</strong>
                                                <?php echo $record['addr']; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="cart-content-right">
                            ...
                            <?php
										...
										$linkkx= 'login.php';
									?>
                            <div style="display:table-cell;" class="tacbox">
                                <input id="checkbox" type="checkbox" />
                                <label for="checkbox"> I agree to these <a style="color:#27a9e0!important;"
                                        href="terms.php">Terms and Conditions</a>.</label>
                            </div>
                            <a style="margin-top:6%;" href="<?php echo $linkkx; ?>" id="chk" class="ho-button ans">
                                <span>Confirm Order</span>
                            </a>

                            <?php if($_SESSION['userid']==18736 || $_SESSION['userid']==48 || $_SESSION['userid']==17888 || $_SESSION['userid']==17575){ ?>
                            <a style="margin-top:6%;" href2="<?php echo $linkkx; ?>" href="#" id="gen1"
                                class="ho-button ans">
                                <span>Confirm Order With Label</span>
                            </a>
                            <div class="wait_label"></div>
                            <?php	}	?>
...
<?php
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="iphone.php"><img  src="wr-m6/uploads/brand1546772237.webp" width="100px" height="80px" alt="Sell '.$brandname.'"></a>
					</div>
					<div>
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="sony.php"><img  src="wr-m6/uploads/brand1546772246.webp" width="100px" height="80px" alt="Sell '.$brandname.'"></a>
					</div>
					<div>
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="oneplus.php"><img  src="wr-m6/uploads/brand1546772276.webp" width="100px" height="80px" alt="Sell '.$brandname.'"></a>
					</div>
					<div>
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="huawei.php"><img  src="wr-m6/uploads/brand1568875281.webp" width="100px" height="80px" alt="Sell '.$brandname.'"></a>
					</div>
					<div>
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="samsung.php"><img  src="wr-m6/uploads/brand1546772254.webp" width="100px" height="80px" alt="Sell '.$brandname.'"></a>
					</div>
					<div>
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="googlepixel.php"><img  src="wr-m6/uploads/brand1569411509.webp" width="100px" height="80px" alt="Sell '.$brandname.'"></a>
					</div>
					<div>
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="motorolawatch.php"><img  src="wr-m6/uploads/brand1570099624.webp" width="100px" height="80px" alt="Sell '.$brandname.'"></a>
					</div>
					<div>
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="alcatel.php"><img  src="wr-m6/uploads/brand1570100535.webp" width="100px" height="80px" alt="Sell '.$brandname.'"></a>
					</div>
					<div>
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="garmin.php"><img  src="wr-m6/uploads/brand1570101901.webp" width="100px" height="80px" alt="Sell '.$brandname.'"></a>
					</div>
					<div>
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="fitbit.php"><img  src="wr-m6/uploads/brand1570181611.webp" width="100px" height="80px" alt="Sell '.$brandname.'"></a>
					</div>
					<div>
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="lgwatch.php"><img  src="wr-m6/uploads/brand1570098718.webp" width="100px" height="80px" alt="Sell '.$brandname.'"></a>
					</div>
					<div>
...
$files=$rowqy['label'];
	...
	$QrCodetxt = "<h1 style='text-align:center'>Please Find Qr Code for Label Print</h1><br/> <img style='display:block;margin-left:auto;margin-right:auto;' src='https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=Label=2|QRCode=$lab  $trackingNumber    |1DBarcode=$trackingNumber|SendersDetails=Recycle Pro
  $address1
  ...
  ";
		...
		$update_sql_array['label'] = $rowqy['label'];
    ...
    <area target="_blank" alt="Email Us Now" title="Email Us Now" href="mailto:info@recyclepro.co.uk" coords="2320,664,1709,519" shape="rect">
					...
					<div style="background:white;">
						<table cellpadding="0" cellspacing="0">
							<tr>
								<td ><img src="https://recyclepro.co.uk/img/recyclepro1.png" style="max-width:100%"></td><br/>
...
<p>All you then need to do is to provide your address from where you wish Royal Mail to collect your Parcel and choose a collection date that suits you before paying for your collection.</p>
	...
	<div style="text-align:center;"><a href="myaccount.php"  class="ho-button">
...
$con = "<h3>dssad</h3>";
    ...
    // Additional headers
    $headers .= 'To:' . "\r\n";
    $headers .= 'From: Admin<noreply@recyclepro.co.uk>' . "\r\n";
    // Mail it
    @mail("sabirsaleem70@gmail.com", "ds", $con, $headers);
...
gtag('event', 'conversion', {
    ...
    'transaction_id': '<?php echo $row['id']; ?>'
});
</script>
