		...
		<div class="row no-gutters">
			...
			<article class="hoproduct">
			        ...
			        <div class="hoproduct-image text-center">
						...
						<a href="sell_laptop.php?id=<?php echo $arr['id']; ?>&pc=<?php echo $_REQUEST['pc']; ?>&b=<?php echo $_REQUEST['b']; ?>"><h2 style="color:#333333; font-size:12px; margin-top:20px;"><?php echo $arr['productname']; ?></h2></a>
						
						<a  href="sell_laptop.php?id=<?php echo $arr['id']; ?>&pc=<?php echo $_REQUEST['pc']; ?>&b=<?php echo $_REQUEST['b']; ?>" class="btn btn-success btn-sm text-white" style="margin-bottom:5px;">Sell Now</a>
						</a>
					</div>
				...
				<article class="hoproduct">
					<div class="hoproduct-image text-center">
						...
						foreach ($record2 as $arr2)
						{
							$i;
						?>
						<a  href="product-view?name=<?php echo str_replace(' ','-',$arr['productname']);?>&pid=<?php echo $arr['id']; ?>&vid=<?php echo $arr2['variant']; ?>" class="btn btn-success btn-sm text-white" style="margin-bottom:5px;"><?php echo $this->getProductVariant($arr2['variant']); ?></a>
						<?php 
						}
						?>
					</div>
...
"@type": "Product",
"name": "<?php echo $product; ?>",
"image": "https://www.recyclepro.co.uk/wr-m6/uploads/<?php echo $row['pro_img']; ?>",
    ...
    <strong>Alert!</strong> *Unfortunately we will not be able to make an offer on this item any longer due to its age. However we can send you a free shipping label or even get it collected and recycle it responsibly. (for collections you will have to place an order 1st and follow the instructions).
			...
			?>
							...
							<div style="margin-top:3%;" id="theDivg" class="col-lg-12">
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/REC-MOB-GOOD-CON.jpg" />	
							<?php
							    }
							    ?>
							     <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/Tablet-Good-Condition.jpg" />	
							<?php
							    }
							    ?>
							     <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/Laptop-Good-Condition.jpg" />	
							<?php
							    }
							    ?>
							     <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/Smart-Watch-Good-Condition.jpg" />	
							<?php
							    }
							    ?>
							     <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/Airpods-Good-Condition.jpg" />	
							<?php
							    }
							    ?>
							    <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/iPod-Good-Condition.jpg" />	
							<?php
							    }
							    ?>
							    <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/Speaker-Good-Condition.jpg" />	
							<?php
							    }
							    ?>
							    <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/Gaming-Console-Good-Condition.jpg" />	
							<?php
							    }
							    ?>
							</div>
							 ...
							 <?php
							    ...
							    {
							    ?>
						<img  style="margin-top:3%;"  src="https://recyclepro.co.uk/images/REC-MOB-WORN-CON.jpg" />	
								<?php
							    }
							    ?>
							     <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/Tablet-Worn-Condition.jpg" />	
							<?php
							    }
							    ?>
							     <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/Laptop-Worn-Condition.jpg" />	
							<?php
							    }
							    ?>
							     <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/Smart-Watch-Worn-Condition.jpg" />	
							<?php
							    }
							    ?>
							     <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/Airpods-Worn-Condition.jpg" />	
							<?php
							    }
							    ?>
							    <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/iPods-Worn-Condition.jpg" />	
							<?php
							    }
							    ?>
							    <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/Speaker-Worn-Condition.jpg" />	
							<?php
							    }
							    ?>
							    <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/Gaming-Console-Worn-Condition.jpg" />	
							<?php
							    }
							    ?>
							</div>
							    ...
							    {
							    ?>
					<img   style="margin-top:3%;" src="https://recyclepro.co.uk/images/REC-MOB-FAULTY-CON.jpg" />	
									<?php
							    }
							    ?>
							     <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/Tablet-Faulty-Condition.jpg" />	
							<?php
							    }
							    ?>
							     <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/Laptop-Faulty-Condition.jpg" />	
							<?php
							    }
							    ?>
							     <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/Smart-Watch-Faulty-Condition.jpg" />	
							<?php
							    }
							    ?>
							     <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/Airpods-Faulty-Condition.jpg" />	
							<?php
							    }
							    ?>
							    <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/iPods-Faulty-Condition.jpg" />	
							<?php
							    }
							    ?>
							    <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/Speaker-Faulty-Condition.jpg" />	
							<?php
							    }
							    ?>
							    <?php
							    ...
							    {
							    ?>
							<img style="margin-top:3%;" src="https://recyclepro.co.uk/images/Gaming-Console-Faulty-Condition.jpg" />	
							<?php
							    }
							    ?>
							</div>
...
<?php
				 ...
				 if($brandname=="Sony" && $c=="Phones")
				{
					...
					<div style="display:flex;cursor:pointer;" class="mt-30" onclick="document.location='sony.php'">
						<div style="margin-right:2%!important;">
						<img src="wr-m6/uploads/brand1546772246.jpg" width="100px" height="60px">
					</div>
					<div>
					<h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling a Sony Device?</h3>
			...
			?>
				 ...
				 if($brandname=="One Plus")
				{
					...
					<div style="display:flex;cursor:pointer;" class="mt-30" onclick="document.location='oneplus.php'">
						<div style="margin-right:2%!important;">
						<img src="wr-m6/uploads/brand1546772276.jpg" width="100px" height="60px">
					</div>
					<div>
					<h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling a One Plus Device?</h3>
					<p style="line-height:initial;margin-top:0px">Please REMOVE your Google account before sending your device to us.</p>
				</div>
					</div>
				<?php
				 ...
				 if($brandname=="Huawei" && $c=="Phones")
				{
					...
					<div style="display:flex;cursor:pointer;" class="mt-30" onclick="document.location='huawei.php'">
						<div style="margin-right:2%!important;">
						<img src="wr-m6/uploads/brand1568875281.png" width="100px" height="60px">
					</div>
					<div>
					<h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling a Huawei Device?</h3>
					<p style="line-height:initial;margin-top:0px">Please REMOVE your Google account before sending your device to us.</p>
				</div>
					</div>
				<?php
				 ...
				 if($brandname=="Samsung" && $c=="Phones")
				{
					...
					<div style="display:flex;cursor:pointer;" class="mt-30" onclick="document.location='samsung.php'">
						<div  style="margin-right:2%!important;" >
						<img  src="wr-m6/uploads/brand1546772254.jpg" width="90px" height="60px">
					</div>
					<div>
					<h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling a Samsung Device?</h3>
					<p style="line-height:initial;margin-top:0px">Please REMOVE your Google account before sending your device to us.</p>
				</div>
					</div>
				<?php
				 ...
				 if($brandname=="Google Pixel")
				{
					...
					<div style="display:flex;cursor:pointer;" class="mt-30" onclick="document.location='googlepixel.php'">
						<div style="margin-right:2%!important;">
						<img src="wr-m6/uploads/brand1569411509.png" width="100px" height="60px" >
					</div>
					<div>
					<h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling a Google Pixel Device?</h3>
					<p style="line-height:initial;margin-top:0px">Please REMOVE your Google account before sending your device to us.</p>
				</div>
					</div>
				<?php
				 ...
				 if($brandname=="Motorola" && $c=="Smart Watch")
				{
					...
					<div style="display:flex;cursor:pointer;" class="mt-30" onclick="document.location='motorolawatch.php'">
						<div style="margin-right:2%!important;">
						<img  src="wr-m6/uploads/brand1570099624.jpg" width="100px" height="60px">
					</div>
					<div>
					<h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling an Motorola Device?</h3>
				 ...
				 if($brandname=="ALCATEL" && $c=="Smart Watch")
				{
					...
					<div style="display:flex;cursor:pointer;" class="mt-30" onclick="document.location='alcatel.php'">
						<div style="margin-right:2%!important;">
						<img  src="wr-m6/uploads/brand1570100535.jpg" width="100px" height="60px">
					</div>
					<div>
					<h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling an ALCATEL Device?</h3>
					<p style="line-height:initial;margin-top:0px">Please Reset your Watch  before sending your device to us.</p>
				</div>
					</div>
				<?php
				 ...
				 if($brandname=="Garmin" && $c=="Smart Watch")
				{
					...
					<div style="display:flex;cursor:pointer;" class="mt-30" onclick="document.location='garmin.php'">
						<div style="margin-right:2%!important;">
						<img  src="wr-m6/uploads/brand1570101901.jpg" width="100px" height="60px">
					</div>
					<div>
					<h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling an Garmin Device?</h3>
					<p style="line-height:initial;margin-top:0px">Please Reset your Watch  before sending your device to us.</p>
				</div>
					</div>
				<?php
				 ...
				 if($brandname=="Fitbit" && $c=="Smart Watch")
				{
					...
					<div style="display:flex;cursor:pointer;" class="mt-30" onclick="document.location='fitbit.php'">
						<div style="margin-right:2%!important;">
						<img  src="wr-m6/uploads/brand1570181611.jpg" width="100px" height="60px">
					</div>
					<div>
					<h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling an Fitbit Device?</h3>
					<p style="line-height:initial;margin-top:0px">Please Reset your Watch  before sending your device to us.</p>
				</div>
					</div>
				<?php
				 ...
				 if($brandname=="LG" && $c=="Smart Watch")
				{
					...
					<div style="display:flex;cursor:pointer;" class="mt-30" onclick="document.location='lgwatch.php'">
						<div style="margin-right:2%!important;">
						<img  src="wr-m6/uploads/brand1570098718.jpg" width="100px" height="60px">
					</div>
					<div>
					<h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling an Fitbit Device?</h3>
					<p style="line-height:initial;margin-top:0px">Please Reset your Watch  before sending your device to us.</p>
...
?>
			...
			<div style="display:flex;border:4px solid #41acff; padding:4%; margin-top:3%;">
								...
								<a href="https://www.recyclepro.co.uk/" class="ho-button ho-button-sm" style="margin-bottom:5px;"><span>Add Device</span></a>
					...
					<div class="ho-form">
						<div class="ho-form-inner">
							...
							<div class="single-input">
								...
								<input type="number" min="00000000" max="99999999" name="account_no" id="account_no" required>
							</div>
						</div>
					</div>
							<div id="country_GB">
								<div class="row">
									<div class="col-sm-12 mt-10">
										...
										<input type="number" min="000000" max="999999"  name="sort_code" id="sort_code">
									</div>
								</div>
							</div>
...
?>
    ...
    <strong>Alert!</strong> *Please select the condition of your device carefully, if it does not match while being checked by our technicians, your evaluation could be revised and shipping charges will occur in case you decide to cancel the order.
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="https://www.recyclepro.co.uk/iphone.php"><img  src="https://www.recyclepro.co.uk/wr-m6/uploads/brand1546772237.jpg" width="100px" height="80px"></a>
					</div>
					<div>
					<a style="text-decoration:none!important;" href="https://www.recyclepro.co.uk/iphone.php"><h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling an Apple Device?</h3></a>
					<a style="text-decoration:none!important;" href="https://www.recyclepro.co.uk/iphone.php"><p style="line-height:initial;margin-top:9px;color:black;">Please REMOVE your iCloud account before sending your device to us.</p></a>
				</div>
					</div>';
				}
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="https://www.recyclepro.co.uk/sony.php"><img  src="https://www.recyclepro.co.uk/wr-m6/uploads/brand1546772246.jpg" width="100px" height="80px"></a>
					</div>
					<div>
					<a style="text-decoration:none!important;" href="https://www.recyclepro.co.uk/sony.php"><h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling an Sony Device?</h3></a>
					<a style="text-decoration:none!important;" href="https://www.recyclepro.co.uk/sony.php"><p style="line-height:initial;margin-top:9px;color:black">Please REMOVE your Google account before sending your device to us.</p></a>
				</div>
					</div>';
				}
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="https://www.recyclepro.co.uk/oneplus.php"><img  src="https://www.recyclepro.co.uk/wr-m6/uploads/brand1546772276.jpg" width="100px" height="80px"></a>
					</div>
					<div>
					<a style="text-decoration:none!important;" href="https://www.recyclepro.co.uk/oneplus.php"><h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling an One Plus Device?</h3></a>
					<a style="text-decoration:none!important;" href="https://www.recyclepro.co.uk/oneplus.php"><p style="line-height:initial;margin-top:9px;color:black">Please REMOVE your Google account before sending your device to us.</p></a>
				</div>
					</div>';
				}
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="https://www.recyclepro.co.uk/huawei.php"><img  src="https://www.recyclepro.co.uk/wr-m6/uploads/brand1568875281.png" width="100px" height="80px"></a>
					</div>
					<div>
					<a style="text-decoration:none!important;" href="https://www.recyclepro.co.uk/huawei.php"><h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling an Huawei Device?</h3></a>
					<a style="text-decoration:none!important;" href="https://www.recyclepro.co.uk/huawei.php"><p style="line-height:initial;margin-top:9px;color:black">Please REMOVE your Google account before sending your device to us.</p></a>
				</div>
					</div>';
				}
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="https://www.recyclepro.co.uk/samsung.php"><img  src="https://www.recyclepro.co.uk/wr-m6/uploads/brand1546772254.jpg" width="100px" height="80px"></a>
					</div>
					<div>
					<a style="text-decoration:none!important;" href="https://www.recyclepro.co.uk/samsung.php"><h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling an Samsung Device?</h3></a>
					<a style="text-decoration:none!important;" href="https://www.recyclepro.co.uk/samsung.php"><p style="line-height:initial;margin-top:9px;color:black">Please REMOVE your Google account before sending your device to us.</p></a>
				</div>
					</div>';
				}
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="https://www.recyclepro.co.uk/googlepixel.php"><img  src="https://www.recyclepro.co.uk/wr-m6/uploads/brand1569411509.png" width="100px" height="80px"></a>
					</div>
					<div>
					<a style="text-decoration:none!important;" href="https://www.recyclepro.co.uk/googlepixel.php"><h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling an Google Pixel Device?</h3></a>
					<a style="text-decoration:none!important;"  href="https://www.recyclepro.co.uk/googlepixel.php"><p style="line-height:initial;margin-top:9px;color:black;">Please REMOVE your Google account before sending your device to us.</p></a>
				</div>
					</div>';
				}
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="https://www.recyclepro.co.uk/motorolawatch.php"><img  src="https://www.recyclepro.co.uk/wr-m6/uploads/brand1570099624.jpg" width="100px" height="80px"></a>
					</div>
					<div>
					<a style="text-decoration:none!important;" href="https://www.recyclepro.co.uk/motorolawatch.php"><h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling an Motorola Device?</h3></a>
					<a style="text-decoration:none!important;"  href="https://www.recyclepro.co.uk/motorolawatch.php"><p style="line-height:initial;margin-top:9px;color:black;">Please Reset your Watch  before sending your device to us.</p></a>
				</div>
					</div>';
				}
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="https://www.recyclepro.co.uk/alcatel.php"><img  src="https://www.recyclepro.co.uk/wr-m6/uploads/brand1570100535.jpg" width="100px" height="80px"></a>
					</div>
					<div>
					<a style="text-decoration:none!important;" href="https://www.recyclepro.co.uk/alcatel.php"><h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling an ALCATEL Device?</h3></a>
					<a style="text-decoration:none!important;"  href="https://www.recyclepro.co.uk/alcatel.php"><p style="line-height:initial;margin-top:9px;color:black;">Please Reset your Watch  before sending your device to us.</p></a>
				</div>
					</div>';
				}
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="https://www.recyclepro.co.uk/garmin.php"><img  src="https://www.recyclepro.co.uk/wr-m6/uploads/brand1570101901.jpg" width="100px" height="80px"></a>
					</div>
					<div>
					<a style="text-decoration:none!important;" href="https://www.recyclepro.co.uk/garmin.php"><h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling an Garmin Device?</h3></a>
					<a style="text-decoration:none!important;"  href="https://www.recyclepro.co.uk/garmin.php"><p style="line-height:initial;margin-top:9px;color:black;">Please Reset your Watch  before sending your device to us.</p></a>
				</div>
					</div>';
				}
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="https://www.recyclepro.co.uk/fitbit.php"><img  src="https://www.recyclepro.co.uk/wr-m6/uploads/brand1570181611.jpg" width="100px" height="80px"></a>
					</div>
					<div>
					<a style="text-decoration:none!important;" href="https://www.recyclepro.co.uk/fitbit.php"><h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling an Fitbit Device?</h3></a>
					<a style="text-decoration:none!important;"  href="https://www.recyclepro.co.uk/fitbit.php"><p style="line-height:initial;margin-top:9px;color:black;">Please Reset your Watch  before sending your device to us.</p></a>
				</div>
					</div>';
				}
           ...
           $link='<div style="display:flex;cursor:pointer;" class="mt-30" >
						<div style="margin-right:2%!important;">
						<a href="https://www.recyclepro.co.uk/lgwatch.php"><img  src="https://www.recyclepro.co.uk/wr-m6/uploads/brand1570098718.jpg" width="100px" height="80px"></a>
					</div>
					<div>
					<a style="text-decoration:none!important;" href="https://www.recyclepro.co.uk/lgwatch.php"><h3 style="font-size:15px;font-weight:600;color:#17a697;margin-bottom:2px;">Selling an LG Device?</h3></a>
					<a style="text-decoration:none!important;"  href="https://www.recyclepro.co.uk/lgwatch.php"><p style="line-height:initial;margin-top:9px;color:black;">Please Reset your Watch  before sending your device to us.</p></a>
				</div>
					</div>';
				}
				?>
...
"noreply@recyclepro.co.uk");
		...
		$this->objMail->Body .= '<div style="background-color: #efefef;color:#000000!important;font-size:13px;line-height:17px;margin:0px 0 0 0px;padding:0px 0 0;width:100%; font-family:Helvetica, sans-serif" bgcolor="#F0F1EB">
					...
					<div style="text-align: center;">
						<img src="https://www.recyclepro.co.uk/img/recyclepro.jpg"  style="max-height:200px!important;"  usemap="#image-map">
