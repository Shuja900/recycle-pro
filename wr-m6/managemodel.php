...
<html lang="en">
<head>
      <?php $layout_obj->pageTitle('Manage Product Variants | Wr-Admin'); ?>
      <!-- Bootstrap -->
      ...
      <div class="container body">
         <div class="main_container">
            ...
            <div class="right_col" role="main">
               <div class="">
                  <?php $layout_obj->PageHeadings('Manage Product Variants'); ?>
                  <div class="clearfix"></div>
                  <?php 
						switch($index){
							case 'add': 
								if($sbtfrm=='sbtval')
									$model_obj->AddFromToDb();
								else 
									$model_obj->AddEditData('Add');
								break; 
							case 'edit':
								if($sbtfrm=='sbtval')
									$model_obj->UpdateFormDb($id);
								else 
									$model_obj->AddEditData('Edit',$id);
								break; 
							default:
									$model_obj->ShowAll();
								break;
