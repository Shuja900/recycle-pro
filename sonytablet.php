...
<body>
    ...
    <div id="wrapper" class="wrapper">
        ...
        <div class="row">
         ...
         <div class="row">
                <div class="col-md-3">
                <a href="sony.php"><img style="border: 2px solid #d2cdcd;"  src="images/sony-phone-button.jpg" >
                </div></a>
                <div class="col-md-3">
                   <a href="sonytablet.php"> <img style="border: 2px solid #41acff;"  src="images/sony-tablet-button.jpg">
                </div></a>
