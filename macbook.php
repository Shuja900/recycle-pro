...
<body>
        ...
        <div class="row">
          ...
          <div class="row">
            <div class="col-md-2">
                ...
                <div class="col-md-2">
                    <a href="macbook.php"> <img style="border: 2px solid #41acff;"  src="images/macbook-button.jpg">
                </div></a>
                <div class="col-md-2">
    ...
    <div style="background-color:#f4f4f4;">
     <div class="container">
      ...
      Removing iCloud from MacBook and MacBook Pro</h3>
                <p style="font-size:19px;text-align:center;">1. Click ‘System Preference’.
                </br>
2. Select ‘iCloud’.
 </br>
...
<img src="images/macbookreset.jpg">
</div>
<div class="col-md-1">
    </div>
<div style="background-color:white;margin-top:5%;margin-bottom:5%;" class="col-md-5">
