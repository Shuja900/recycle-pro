...
header("location:https://www.recyclepro.co.uk/wr-m6/manageorders.php?success=true&message='.$message");
    }
    else
    {
    $message = '<div class="alert alert-danger">There Is Some Error  </div>';
header("location:https://www.recyclepro.co.uk/wr-m6/manageorders.php?success=false&message='.$message");
    }
