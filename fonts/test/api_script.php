...
putenv('TMPDIR=/home/recycleproco/public_html/tmp');
...
if(isset($_POST['getLabel'])){
  ...
  $orderIdentifier = $json['createdOrders'][0]['orderIdentifier'];



  $apiInstance2 = new RoyalMail\ClickAndDrop\Rest\Api\LabelsApi(
      // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
      // This is optional, `GuzzleHttp\Client` will be used as default.
      new GuzzleHttp\Client(),
      $config
  );
  $orderIdentifiers = $orderIdentifier; // string | Order Identifier or several Order Identifiers separated by semicolon
  ...
  $result = $apiInstance2->getOrdersLabelAsync($orderIdentifiers, $documentType, $includeReturnsLabel,$includeCN);
...
echo "<img style='width:120px' src='/wr-m6/uploads/$pro_img'/>";
}
