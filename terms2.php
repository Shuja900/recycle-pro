                            ...
                            <div class="tab-vertical">
                                ...
                                <div class="tab-content" id="myTabContent3">
                                    ...
                                    <div class="tab-pane fade" id="profile-vertical" role="tabpanel" aria-labelledby="profile-vertical-tab">
                                        ...
                                        <h4>We pay quicker than other sites for your unwanted items</h4><p>Other sites generally take 3-5 business days to transfer payments, but as much as we care for the environment, we care about your time too. Instead of such a long wait, we will pay you the same day we receive your tech. Isn’t that convenient?</p>
                                        <h4>Get fast cash for your Tech</h4>
                                        <p>Our technicians will run a quick quality assessment check right after we receive your device. You will be paid the exact amount quoted to you ON THE SAME DAY. You don’t have to worry about the price of your tech as our Tech Price Promise quotes you the best price, and if you’re unhappy with it, you can get your device back for FREE</p>
                                        <h4>Faster than BACS transfer</h4>
                                        <p>Selling your tech is easier when you know when you will be paid. Instead of the 3-5 working days that other sites take to transfer payment through BACS, we save your time and pay you the SAME DAY we receive your device.</p>
                                        ...
                                        <h5>*Fast same day payment applies to items received before 2 pm. Working days exclude Saturdays, Sundays, and public holidays. Items received after 2pm will be paid for the next working day. In case the customer has received a revised price offer from us, the payment will be processed after the customer has responded to the offer.</h5>
                                    </div>
                                    ...
                                    <ol type="1">
                                        ...
                                        <p>Once the customer has selected a payment method, it cannot be changed, and the customer is solely responsible for the validity and accuracy of the payment details, including but not limited to the account holder’s name, account number, and sort code.</p><p>A customer may make changes in the payment details (not the payment method) in the website's "My Account" section, bearing the responsibility to do so before the issuance of payment.</p><p>We are not liable under any circumstance for the legitimacy and validity of the payment details provided by you, and you are solely responsible for ensuring the validity, correctness, and accuracy of the payment details provided by you on the Website.</p><p>We will not assume any responsibility for any losses you may incur if you are unable to receive your money if it is transferred to an incorrect account as an outcome of your failure to present accurate, valid, and correct payment details required on the website.</p><p>You recognise and acknowledge that some of the payment options provided to you rely on third parties (parties outside of our control, including but not limited to banks and postal services) to process the payments, including but not limited to payments made by bank transfer. We will not be held responsible for payment delays brought on by these third parties' actions or inactions. Payments may be subject to verification and security procedures required by us or a third party.</p><p>If you decide to donate the money you have raised through your sale, to one of our chosen charities, the method of payment will not be changeable once you have clicked on "Confirm your Order" after completing your sale and being displayed the confirmation page. The donation will be paid to the selected charity in accordance with our arrangement with that particular charity.</p><p>Please be aware that Recycle Pro can only reissue payments to you by bank transfer, and that we will need your account information to do so. The method through which reissue payments are made is entirely up to us. We have the right to impose additional administrative fees in the form of a deduction from your account or a payment from you if you give inaccurate bank account information for a reissue and a payment is rejected by your bank when you apply for another reissue.</p><p>All stated payment schedules are subject to change at peak times or in the event of an unforeseen circumstance. If, for any reason, we are unable to make a payment within the timeframes specified, you will not be entitled to compensation from us for any losses you may incur.</p><p>To assist you in seeing the entire sum you will receive, all payments include VAT (subject to these terms and conditions)</p><p>The applicable terms and conditions of those conditions will apply to any transactions made in line with any of the promotional offers listed in the conditions (inclusive) below.</p>
                                    </div>
                                    ...
                                    <table style="width:100%">
                                        ...
                                        <th>    
                                            <img src="ban-01.png" alt="Trulli" width="500" height="340">
                                        </th>    
                                        </tr> 
                                    </table>
                                    <table style="width:100%">
                                    ...
                                    <table style="width:100%">
                                        ...
                                        <th>    
                                            <img src="Ban-2.webp" alt="Trulli" width="438" height="462">
                                        </th>    
                                        </tr> 
                                    </table>
                                    ...
                                    <table style="width:100%">
                                        ...
                                        <th>    
                                        <img src="ban-3.jpg" alt="Trulli" width="500" height="500">
                                        </th>    
                                        </tr>
                                    </table>
                                    <ol>
                                        ...
                                        <p>Call: <a href="tel:+441216303773">+441216303773</a></p>
                                    ...
                                    <table style="width:100%">
                                        ...
                                        <th>    
                                        <img src="ban-4.jpg" alt="Trulli" width="600" height="500">
                                        </th>    
                                        </tr>
                                    </table>
                                    ...
                                    <table>
                                        <tr>
                                            <th style="background-color: #18bdd8; color: #fff;">Type of Information</th>
                                            <th style="background-color: #18bdd8; color: #fff;">Reason for Utilization</th>
                                            <th style="background-color: #18bdd8; color: #fff;">Legal Justification</th>
                                        </tr>
                                        <tr>
