...
<body>
    ...
    <div id="wrapper" class="wrapper">
        ...
        <div class="row">
            <div class="col-md-6">
                <img src="images/motorolawatchreset.jpg">
            ...
            <div class="col-md-6">
                ...
                <p style="font-size:19px;text-align:justify;">1. Go to the Start screen.               </br>
2. Scroll to the right.Scroll down.
 </br>
3.  Choose Settings.Scroll down.
 </br>
4. Choose Unpair with phone.
</br>
5. Choose the tick symbol.
</br>
6. The device will automatically reset and reboot.
</p>
            </div>
        </div>
