...
<body>
    ...
    <div id="wrapper" class="wrapper">
        ...
        <div class="row">
            <div class="col-md-5">
                <img src="images/samsungbackground.jpg">
                
            </div>
            <div class="col-md-7">
                <div class="row">
            <div class="col-md-12">
                <h3 style="font-size:23px;font-weight:600!important;color:#17a697!important;margin-top:5%;">How to unlock your Samsung device.</h3>
                <p style="font-size:19px;font-weight:600!important;">Before you send your Samsung phone or tablet to us, you’ll need to remove your Google account. If you don’t, your payment may be delayed.</p>
                <p style="font-size:19px;">Removing your account is quick and easy. Just follow the simple steps below.</p>
            </div>
        </div>
         <div class="row">
                <div class="col-md-3">
                <a href="samsung.php"><img style="border: 2px solid #d2cdcd;"  src="images/samsung-phone-button.jpg" >
                </div></a>
                <div class="col-md-3">
                   <a href="samsungtablet.php"> <img style="border: 2px solid #d2cdcd;"  src="images/samsung-tablet-button.jpg">
                </div></a>
                <div class="col-md-3">
                   <a href="samsungwatch.php"> <img style="border: 2px solid #41acff;"  src="images/samsung-watch-button.jpg">
                </div></a>
    ...
    <div style="background-color:#f4f4f4;">
     <div class="container">
      ...
      To factory reset the Samsung Galaxy Watch:</h3>
                <p style="font-size:19px;text-align:center;">1. Flick down from the top of the watch face and select the Settings cog icon.                </br>
...
<img src="images/samsungwatchreset.jpg">
...
<a  style="padding:4%;background-color:#17a697;color:white;font-weight:600!important;border-radius: 9px;" href=""  >Go to Samsung.com</a>
</div>
</div>
</div>
</div>
