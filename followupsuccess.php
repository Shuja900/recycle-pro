...
<body>
  ...
  <h1 class="display-3">Follow Up Email Has Sent Succesfully </h1>
 
  <hr>
  
  <p class="lead">
    <a style="color:white;" class="btn btn-primary btn-sm" href="https://www.recyclepro.co.uk/" role="button">Continue to homepage</a>
  </p>
</div>
        </main>
        <!--// Page Conttent -->
