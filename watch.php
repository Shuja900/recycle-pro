...
<body>
        ...
        <div class="row">
          ...
          <div class="row">
            <div class="col-md-2">
                ...
                <div class="col-md-2">
                    <a href="ipod.php"> <img style="border: 2px solid #d2cdcd;"  src="images/ipod-button.jpg">
                </div></a>
                <div class="col-md-2">
                    <a href="watch.php"> <img style="border: 2px solid #41acff;"  src="images/watch-button.jpg">
                </div></a>
                <div class="col-md-2">
    ...
    <div style="background-color:#f4f4f4;">
     <div class="container">
      ...
      How to remove Activation Lock from your Apple Watch</h3>
                <p style="font-size:19px;text-align:center;">1. Hold your Apple Watch and iPhone close together.
                </br>
...
<div style="background-color:white;margin-top:5%;margin-bottom:5%;" class="col-md-5">
                <h3 style="font-size:23px;font-weight:600!important;color:#17a697!important;margin-top:5%;text-align:center;">
      How to remove Activation Lock from your Apple Watch remotely</h3>
                <p style="font-size:19px;text-align:center;">1. Go to iCloud.com and sign in with your Apple ID
                </br>
2. Open ‘Find My Watch’.
 </br>
3. Go to ‘My Devices’ and select your Apple Watch.
 </br>
4. Click the ‘Erase Apple Watch’ next to your device.
 </p>
