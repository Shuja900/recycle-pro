...
require_once('apps/wrback/network/network.class.php');
$layout_obj = new LayoutClass();
$frntbs_obj = new FrontBase();
$network_obj = new NetworkClass();
...
<html lang="en">
<head>
      <?php $layout_obj->pageTitle('Manage Network | Wr-Admin'); ?>
      <!-- Bootstrap -->
      ...
      <div class="container body">
         <div class="main_container">
            ...
            <div class="right_col" role="main">
               <div class="">
                  <?php $layout_obj->PageHeadings('Manage Network Categories'); ?>
                  <div class="clearfix"></div>
                  <?php 
						switch($index){
							case 'add': 
								if($sbtfrm=='sbtval')
									$network_obj->AddFromToDb();
								else 
									$network_obj->AddEditData('Add');
								break; 
							case 'edit':
								if($sbtfrm=='sbtval')
									$network_obj->UpdateFormDb($id);
								else 
									$network_obj->AddEditData('Edit',$id);
								break; 
							case 'Delete':
									$network_obj->DeleteData($id);
								break;
							default:
									$network_obj->ShowAll();
								break;
