                                 ...
                                 <table class="table table-striped jambo_table bulk_action">
									...
									?>
                                       <tr class="even pointer odd pointer">
                                          ...
                                          ?>
                                          <a href="managepages.php?index=edit&id=<?php echo $arr['id']; ?>">Edit</a>
                                          <?php 
										  if($arr['deloption']=='No') {
											  ?>
...
function AddFromToDb(){
	...
	$insert_sql_array['img_alt'] = $deloption;
	$insert_sql_array['img_title'] = $deloption;
	if($path!='') {
...
function UpdateFormDb($id){
	...
	$update_sql_array['img_alt'] = $deloption;
	$update_sql_array['img_title'] = $deloption;
	if($path!='') {
