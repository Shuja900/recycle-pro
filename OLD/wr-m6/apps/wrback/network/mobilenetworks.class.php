                                 ...
                                 <table class="table table-striped jambo_table bulk_action">
									...
									?>
                                       <tr class="even pointer odd pointer tr_delete">
										  ...
										  <td class=" "><?php echo $this->getNetworkCatData($arr['network_cat']); ?></td>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                       <select name="network_cat" id="network_cat" class="form-control col-md-7 col-xs-12">
											...
											<?php 
												...
												{
											?>
													<option value="<?php echo $arr['id']; ?>" <?php if($arr['id']==$this->network_cat) echo 'selected="selected"';?>><?php echo $arr['name']; ?> - &pound;<?php echo $arr['price']; ?></option>
											<?php 
												} 
											?>
									   </select>
