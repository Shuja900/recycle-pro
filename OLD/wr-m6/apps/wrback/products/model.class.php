	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
			   ...
			   <div class="x_content">
			   		<p>Manage all <code>Product Categories Models</code> which you will provide.</p>
...
function AddEditData($mode='Add',$id=''){
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
			   <div class="x_title">
				  <h2><?php echo $mode; ?> Model</h2>
				  <div class="pull-right"><a class="btn btn-info" href="managemodel.php">Back</a></div>
				  <div class="clearfix"></div>
			   </div>
			   <div class="x_content">
			   		<p>Mannualy <?php echo $mode; ?> <code>Model</code>.</p>
			   		<form class="form-horizontal form-label-left" action="" method="post" name="adduserfrm" id="adduserfrm">
                                 <span class="section">Model Info</span>
                                 <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Model Name <span class="required">*</span>
                                    </label>
