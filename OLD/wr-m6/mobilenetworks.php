...
require_once('apps/wrback/network/mobilenetworks.class.php');
$layout_obj = new LayoutClass();
$frntbs_obj = new FrontBase();
$mobnet_obj = new MobileNetworks();
...
<html lang="en">
<head>
      <?php $layout_obj->pageTitle('Manage Mobile Networks | Wr-Admin'); ?>
      <!-- Bootstrap -->
      ...
      <div class="container body">
         <div class="main_container">
            ...
            <div class="right_col" role="main">
               <div class="">
                  <?php $layout_obj->PageHeadings('Manage Mobile Networks'); ?>
                  <div class="clearfix"></div>
                  <?php 
						switch($index){
							case 'add': 
								if($sbtfrm=='sbtval')
									$mobnet_obj->AddFromToDb();
								else 
									$mobnet_obj->AddEditData('Add');
								break; 
							case 'edit':
								if($sbtfrm=='sbtval')
									$mobnet_obj->UpdateFormDb($id);
								else 
									$mobnet_obj->AddEditData('Edit',$id);
								break; 
							case 'Delete':
									$mobnet_obj->DeleteData($id);
								break;
							default:
									$mobnet_obj->ShowAll();
								break;
