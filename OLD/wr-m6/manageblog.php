...
require_once('apps/wrback/blog/blog.class.php');
...
<html lang="en">
<head>
      <?php $layout_obj->pageTitle('Manage Blog | Wr-Admin'); ?>
      <!-- Bootstrap -->
      ...
      <div class="container body">
         <div class="main_container">
            ...
            <div class="right_col" role="main">
               <div class="">
                  <?php $layout_obj->PageHeadings('Manage Blog'); ?>
                  <div class="clearfix"></div>
                  <?php 
						switch($index){
							case 'add': 
								if($sbtfrm=='sbtval')
									$blog_obj->AddFromToDb();
								else 
									$blog_obj->AddEditData('Add');
								break; 
							case 'edit':
								if($sbtfrm=='sbtval')
									$blog_obj->UpdateFormDb($id);
								else 
									$blog_obj->AddEditData('Edit',$id);
								break;
							case 'sub':
									$blog_obj->ShowAll('sub',$pid);
								break;
							case 'subadd': 
								if($sbtfrm=='sbtval')
									$blog_obj->AddFromToDb();
								else 
									$blog_obj->AddEditData('Add','','sub',$pid);
								break; 
							default:
									$blog_obj->ShowAll();
								break;
