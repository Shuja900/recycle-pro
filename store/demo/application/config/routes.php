...
$route['show_post_by_cat_id/(.+)'] = 'Home/show_post_by_cat_id/$1';
// Contact Form
...
$route['show_product_by_filter'] = 'Home/show_product_by_filter';
...
$route['add_variation'] = 'Product/add_variation_form';
$route['add_phone_variation'] = 'Product/add_phone_variation_form';
$route['insert_variation'] = 'Product/insert_variation';
$route['insert_phone_variation'] = 'Product/insert_phone_variation';
$route['add'] = 'Product/add';
$route['add_bulk_product'] = 'Product/importview';
$route['import_products'] = 'Product/importdata';
