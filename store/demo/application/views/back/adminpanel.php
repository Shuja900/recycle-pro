        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-tags fa-fw"></i> Brand Option<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            
                             <li>
                                 <a href="<?php echo base_url();?>add-sub-category"><i class=""></i>Add Brands</a>
                             </li>
                            
                            <li>
                                 <a href="<?php echo base_url();?>sub-category-list"><i class=""></i>Brands List</a>
                            </li>
                        </ul>
                    </li>
                      <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-product-hunt fa-fw"></i>Bulk Products Option<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                 <a href="<?php echo base_url();?>add_bulk_product"><i class=""></i>Add Bulk Product</a>
                             </li>
                            <li>
                                 <a href="<?php echo base_url();?>product-list"><i class=""></i>Update Bulk Product</a>
                            </li>
                        </ul>
                    </li>
