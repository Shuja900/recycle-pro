                           ...
                           <h5 style='color:red'> <?php echo validation_errors();?></h5>
                             <?php echo form_open_multipart('update-product','');?>
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <select class="form-control" name="pro_brand">
                                      <option vaue="<?php echo $all_product->pro_brand;?>"><?php echo $all_product->pro_brand;?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  name="colour" value="<?php echo $all_product->colour;?>" required>
                                </div>
                               
                                <div class="form-group">
                                    <label>Product Status</label>
                                    <select class="form-control" name="status"  required>
                                      <?php if($all_product->pro_status==2){?>
                                        <option selected="" value="2">Show</option>
                                          <option value="1">Hide</option>
                                        <?php }elseif($all_product->pro_status==1){?>
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="<?php echo base_url();?>uploads/<?php echo $all_product->pro_image;?>" width="80" height="50"/>

                                </div>
                                <div class="form-group">
                                    <label>Upload Product Image</label>
                                    <input type="file" name="pro_imageone">
                                    <input type="hidden" name="old_pro_image1" value="<?php echo $all_product->pro_imageone;?>">
                                    <img src="<?php echo base_url();?>uploads/<?php echo $all_product->pro_imageone;?>" width="80" height="50"/>

                                </div>
                                <div class="form-group">
                                    <label>Upload Product Image</label>
                                    <input type="file" name="pro_imagetwo">
                                    <input type="hidden" name="old_pro_image2" value="<?php echo $all_product->pro_imagetwo;?>">
                                    <img src="<?php echo base_url();?>uploads/<?php echo $all_product->pro_imagetwo;?>" width="80" height="50"/>
