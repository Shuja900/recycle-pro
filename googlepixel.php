...
<body>
    ...
    <div id="wrapper" class="wrapper">
        ...
        <div class="row">
            <div class="col-md-5">
                <img src="images/googlepixelbackground.jpg">
                
            </div>
            <div class="col-md-7">
                <div class="row">
            <div class="col-md-12">
                <h3 style="font-size:23px;font-weight:600!important;color:#17a697!important;margin-top:5%;">How to unlock your Google Pixel device.</h3>
                <p style="font-size:19px;font-weight:600!important;">Before you send your Google Pixel phone  to us, you’ll need to remove your Google account. If you don’t, your payment may be delayed.</p>
                <p style="font-size:19px;">Removing your account is quick and easy. Just follow the simple steps below.</p>
            </div>
        </div>
        <div class="row">
                <div class="col-md-3">
                <a href="googlepixel.php"><img style="border: 2px solid #41acff;"  src="images/pixel-phone-button.jpg" >
                </a>
            </div>
        </div>
         </div>
...
<a  style="padding:4%;background-color:#17a697;color:white;font-weight:600!important;border-radius: 9px;" href=""  >Go to Googlepixel.com</a>
</div>
</div>
</div>
</div>
