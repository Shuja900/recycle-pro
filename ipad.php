...
<body>
        ...
        <div class="row">
         ...
         <div class="row">
            <div class="col-md-2">
                ...
                <div class="col-md-2">
                   <a href="ipad.php"> <img style="border: 2px solid #41acff;"  src="images/ipad-button.jpg">
                </div></a>
                <div class="col-md-2">
    ...
    <div style="background-color:#f4f4f4;">
     <div class="container">
      ...
      Removing your iCloud account using your iPad</h3>
                <p style="font-size:19px;text-align:center;">1. Select ‘Settings’ and tap ‘iCloud’.
                </br>
2. Select ‘Find my iPad’.
 </br>
3. Slide the ‘Find my iPad’ button to off.
 </br>
